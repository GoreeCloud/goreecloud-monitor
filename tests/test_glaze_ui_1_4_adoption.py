...
class GlazeUi14HistoricalEvidenceTests(SimpleTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.current = json.loads((cls.base / "docs/glaze-ui-v1.6.0-adoption.json").read_text(encoding="utf-8"))
    ...
    def test_1_4_is_not_the_current_consumer_target(self):
        ...
        self.assertEqual(glaze["required_release"], "1.6.0")
        self.assertEqual(self.current["required_target_release"], "1.6.0")
