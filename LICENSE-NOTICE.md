# GoreeCloud Monitor License Notice

Current GoreeCloud Monitor source is licensed under the GNU Affero General Public License, version 3 only (`AGPL-3.0-only`).
