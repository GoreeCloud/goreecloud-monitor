...
MONITOR_CHECK_RETENTION_DAYS = max(1, min(3650, int(os.getenv("MONITOR_CHECK_RETENTION_DAYS", "30"))))
MONITOR_JOB_EVENT_RETENTION_DAYS = max(1, min(3650, int(os.getenv("MONITOR_JOB_EVENT_RETENTION_DAYS", "90"))))
MONITOR_HISTORY_PRUNE_INTERVAL_SECONDS = max(60, min(86400, int(os.getenv("MONITOR_HISTORY_PRUNE_INTERVAL_SECONDS", "3600"))))
