...
> **Current state:** source-stable release candidate with migration-readiness work in progress. Uptime Kuma remains the production monitoring platform until GoreeCloud Monitor completes target-environment deployment, parallel validation, recovery testing, and an explicit cutover.
...
- Conservative Uptime Kuma/kuma-cli audit, paused-by-default import, and definition-comparison tooling
...
See `docs/architecture.md`, `docs/deployment.md`, `docs/backup.md`, `docs/recovery.md`, `docs/uptime-kuma-migration.md`, and `SECURITY.md`.
